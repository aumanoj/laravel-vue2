  ...
  <div class="container">
    <div class="row desktop-view">
      <div class="col-md-2 col-sm-3 col-12">
        ...
        <img src="{{url('images/pay-mode.jpg')}}" alt="Pay Mode" width="180px" class="img-fluid" />
      </div>
              ...
              <div id="myCarousel" class="carousel slide">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="carousel-content">
                      <div itemscope itemtype="https://schema.org/Review">
                        <p itemprop="comment">Thanks for such a fast unlocking service.my smartphone was barred and it was impossible to use but Now i can use my smartphone anywhere because its now factory unlocked.</p>
                        <p>
                  ...
                  <div class="carousel-item">
                    <div class="carousel-content">
                      <div itemscope itemtype="https://schema.org/Review">
                        <p itemprop="comment">Best service and they do what they said i have done two unlocking of SAMSUNG GALAXY NOTE 3 and they done in time they said..excellent service and good value of money and trust me its not a scam website.</p>
                        <p>
                          <span itemscope itemtype="https://schema.org/Person">
    ...
    <div class="panel-group mobile-view" id="accordion" role="tablist" aria-multiselectable="true" itemscope itemtype="https://schema.org/WPFooter">
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#footlinks" aria-expanded="false" aria-controls="footlinks" itemprop="name">
