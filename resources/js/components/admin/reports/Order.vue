                ...
                <table class="table" id="datatable">
                  ...
                  <tbody v-for="order in orders.data" :key="order.id">
                    <tr>
                      ...
                      <td>{{ order.tool!=null?order.tool.tool_name:'' }}</td>
                      <td>{{ order.tool!=null?order.tool.selling_price:'' }}</td>
                      <td>{{ order.tool!=null?order.tool.api_price:'' }}</td>
                      ...
                      <td v-if="order.unlock_status == 0">{{ "Unprocessed" }}</td>
              ...
              <div class="card-body">
                ...
                >
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                      {{ order.tool!=null?order.tool.tool_id:'' }}
                    </div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-md-2 ml-5">Tool :</div>
                    <div class="col-md-6">
                      {{ order.tool!=null?order.tool.tool_name:'' }}
                    </div>
                  </div>
                  <div class="row mt-2">
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                      ...
                      <select id="select"
                        class="form-control"
                        v-model="order.tool.tool_id"
                        
                      >
                        <option value="" class="short" selected disabled>
                          Please Select Tool
                        </option>
                        <option  class="short" v-for="order in orderDetails.tools" :key="order.id" :value="order.tool_id">
                          {{ order.tool_name }}
                        </option>
                      </select>
                    </div> 
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                      ...
                      <button
                        type="button" @click.prevent="reOrder(order.tool!=null ?order.tool.tool_id:'' , order.tbl_orders!=null ?order.tbl_orders.order_id:'' )"
                      ...
                      <button type="button" @click.prevent="reFund(order.tbl_orders!=null ?order.tbl_orders.order_id:'' )"
                  ...
                  <hr />
                  <div class="row mt-3" v-for="comments in orderDetails.comments" :key="comments.id">
                    <div class="col-md-2 ml-5">Comment - {{ moment(comments.created).format("DD-MM-YYYY hh:mm") }} :</div>
                    <div class="col-md-6"><p>{{ comments!=null?comments.comment:'' }}</p></div>
                  </div>
  ...
  mounted() {
    ...
    // Tool select option setting width
      ...
      require("../../../../../public/plugins/daterangepicker/daterangepicker");
       //require("../../../../../public/pages/jquery.forms-advanced");
...
function ($) {
  ...
  methods: {
    ...
    getOrders(page) {
      ...
      Url.get("/getOrders?page=" + page).then((response) => {
    ...
    getOrder(e) {
      ...
      Url.get("/getOrder/" + data_id).then((response) => {
