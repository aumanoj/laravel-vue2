          ...
          <div class="page-title-box">
            <div class="float-right">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create-Models</li>
              </ol>
            </div>
            <h4 class="page-title">Create-Models</h4>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mt-4">
              <div class="col-md-2 ml-5"><b>Model Name</b><b class="required"> *</b></div>
              <div class="col-md-6">
                <input 
                  type="text"
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-6">
                <button
                  type="button" @click.prevent="createModels"
  ...
  export default {
    ...
    methods: {
      ...
      createModels() {
        ...
        this.data.append('model_name',this.model_name)
        this.data.append('status',this.status)
        this.data.append('priority_number',this.priority_number)
      
        Url.post("/createModel" ,this.data)
          .then((response) => {
            Vue.$toast.open({
