...
namespace App\UnlockBase;
	/*
		...
		This is a PHP 4/5/7 library for connecting the UnlockBase API (v3)
	...
	*/
	...
	define('UNLOCKBASE_API_KEY', '(B35D-585F-69D0-15DA)');
	...
	define('UNLOCKBASE_API_URL', 'https://www.unlockbase.com/xml/api/v3');
