              ...
              <div class="row">
                ...
                >
                  <button
                    ...
                    class="btn btn-primary px-3 py-2 float-right"
                  >
                    Please Verify Email
                  </button>
                </div>
...
export default {
  ...
  methods: {
    ...
    getUser() {
      ...
      // }, 1000);
      Url.get("/editProfile/" + this.$route.params.id)
        .then((response) => {
    ...
    updateUser() {
      ...
      if (this.submit == true) {
        Url.post("/updateProfile/" + this.$route.params.id, {
    ...
    resend_code() {
      Url.get("/email/resend").then((response) => {
        Vue.$toast
          .open({
